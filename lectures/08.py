...
# gunicorn
# схема разврертывания
# nginx -> gunicorn -> scrypt.py
#   V               |-> scrypt.py
# static content    |-> scrypt.py
...
# https://nbviewer.jupyter.org/github/ResearchComputing/Meetup-Fall-2013/blob/master/python/lecture_07_numpy.ipynb
...
# https://nbviewer.jupyter.org/github/ResearchComputing/Meetup-Fall-2013/blob/master/python/lecture_10_pandas_introduction.ipynb
...
Книга по обработке данных
Wes McKinney "Python Data Analysys"

Галерея лучших блокнотов по ML и Data Science 
https://habr.com/ru/post/460321/

Больше примеров про pandas и обработку данных
https://nbviewer.jupyter.org/github/ResearchComputing/Meetup-Fall-2013/tree/master
"""